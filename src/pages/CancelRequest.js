    ...
    <View style={styles.background}>
      <ScrollView style={styles.scrollView}>
        <View style={styles.container}>
          ...
          <Text style={styles.title}>Certeza que deseja cancelar o pedido?</Text>

          
          <TouchableOpacity
            style={styles.buttonCancel}
          >
            <Text style={styles.buttonText}>Voltar para o pedido</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.button}
            onPress={onPress}
          ...
          <Text>Serão apagado todos os registros do pedido.</Text>
